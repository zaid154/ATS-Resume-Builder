...
export default function TimelineTemplate({ data }) {
  ...
  return (
    <div className="resume-doc tpl-timeline">
      ...
      {isDocEmpty ? (
        ...
        <>
          ...
          {hasArr(data.experience) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Experience Timeline</h2>
              <div className="timeline-container">
                {data.experience.map((e, i) => (
                  <div className="rd-item timeline-item" key={i}>
          ...
          {hasArr(data.skills) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Skills & Stack</h2>
