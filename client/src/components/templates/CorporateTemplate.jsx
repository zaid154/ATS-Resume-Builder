...
export default function CorporateTemplate({ data }) {
  ...
  return (
    <div className="resume-doc tpl-corporate">
      ...
      {isDocEmpty ? (
        ...
        <>
          ...
          {hasArr(data.education) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Education & Academic Achievements</h2>
          ...
          {hasArr(data.skills) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Areas of Expertise</h2>
