...
export default function MinimalSerifTemplate({ data }) {
  ...
  return (
    <div className="resume-doc tpl-minimal-serif">
        ...
        <>
          {p.summary && (
            <section className="rd-section">
              <h2 className="rd-section-title">Background</h2>
              <p>{p.summary}</p>
            </section>
          )}
          ...
          {hasArr(data.experience) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Work History</h2>
          ...
          {hasArr(data.skills) && (
            <section className="rd-section">
              <h2 className="rd-section-title">Competencies</h2>
